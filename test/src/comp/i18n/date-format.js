...
describe('DateFormat', () => {
    const dt = new Date(2025, 0, 2, 3, 4, 5, 6);
    ...
    it('should format date', () => {
        expect(DateFormat.dStr(dt)).to.eql('Jan 2, 2025');
    });

    it('should format date and time', () => {
        expect(DateFormat.dtStr(dt)).to.eql('Jan 2, 2025, 3:04:05 AM');
    });

    it('should format date and time in sortable format', () => {
        expect(DateFormat.dtStrFs(dt)).to.eql('2025-01-02T03-04-05');
    });
});
